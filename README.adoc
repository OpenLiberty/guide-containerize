...
Run the following commands to stop and remove the `inventory` container and re-run it with the `default.http.port` environment variable set:
...
and you can add your local system properties at
`\http://localhost:9091/inventory/systems/pass:c[[system-ip-address]]`.
