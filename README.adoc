...
[hotspot=httpEndpoint file=0]`<httpEndpoint>` element to define the service's
...
specified. To find a value for this variable, Open Liberty will look for the
...
The `system` service remains unchanged and available at
