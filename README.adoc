...
The [hotspot=configure-sh file=0]`RUN configure.sh` command should be placed at the last to get a pre-warmed container. It will improve the startup time of running the container.
