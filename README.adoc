...
[role='command']
```
mvn -pl inventory failsafe:integration-test -Dsystem.ip=[system-ip-address]
```
...
Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.653 s - in it.io.openliberty.guides.system.SystemEndpointIT
