...
The system properties of your localhost can be added to the **inventory** at **http://localhost:9081/inventory/systems/localhost**. Run the following curl command:
```
...
// Following context for the cloud-hosted guide:
ifdef::cloud-hosted[]
Run the following commands that visit to **http://localhost:9081/inventory/systems/[system-ip-address]** by replacing **[system-ip-address]** with the IP address you obtained earlier.
```
...
The `inventory` service will now be available on the new port number you
specified. You can see the contents of the inventory at
**http://localhost:9091/inventory/systems**. Run the following curl command:
```
...
**http://localhost:9080/system/properties**. Run the following curl command:
```
curl http://localhost:9080/system/properties
```
{: codeblock}
