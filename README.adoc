...
To try out the application, first navigate to the `start` directory and then run the following Maven goals to build the application and run it inside Open Liberty:
```
cd start
