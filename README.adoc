...
Learn how to containerize and run your microservices with Open Liberty on Docker.
...
container logs for any potential problems. Run the `docker stats system` and `docker stats inventory` to display a live stream of the containers usage statistics. You can also double-check that your Dockerfiles are correct. When you
...
You have just built Docker images for two microservices on Open Liberty. 
